	...
	return (
		<>
			<div className="flex max-w-screen-prose mb-20">
				<div className="flex items-start xl:ml-40 ml-10 flex-1 justify-center min-h-screen flex-col">
					...
					<h2 className="text-xl xl:text-4xl xl:mb-32 mb-10 font-semibold antialiased">
						<motion.p
					...
					<h1 className="text-3xl xl:text-9xl font-semibold antialiased">
						<motion.p
							variants={whatIdoVariant}
							ref={ref}
							initial="hidden"
