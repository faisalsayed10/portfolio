	...
	return (
		<>
			...
			<div className="px-10">
				...
				<div className="flex items-center justify-center m-4 text-gray-600 font-medium">
					<Link href="/carbon-slack/privacy-policy">
						<p className="pr-4">Privacy Policy</p>
					</Link>
					<Link href="/carbon-slack/tos">
						<p className="pl-4">Terms of Service</p>
					</Link>
				</div>
			</div>
		</>
