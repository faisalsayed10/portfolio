...
const tos = (props: Props) => {
  return (
    <div className="mx-6 text-left text-gray-500">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Carbon Slack.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Carbon Slack, accessible from{" "}
            <a
              href="https://carbon-slack.netlify.app/slack"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://carbon-slack.netlify.app/slack
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: faisal.sayed502@gmail.com</li>
      </ul>
    </div>
  );
}
